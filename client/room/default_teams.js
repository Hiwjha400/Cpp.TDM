...
export const RED_TEAM_NAME = "ИГРОКИ";
export const BLUE_TEAM_NAME = "ИГРОКИ";
...
export const BLUE_TEAM_COLOR = new Color(0, 1, 1, 0);
export const RED_TEAM_COLOR = new Color(1, 1, 0, 0);
